  ...
  return {
    ...
    async leaveGroup(input: {
      ...
      if (result.kind === "dissolved") {
        // This hook intentionally runs after the repository transaction has
        // committed. Future activity recording can use this seam without
        // coupling groups to notifications or wishes.
