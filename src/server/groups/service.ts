 ...
 * database connection during Next.js build/route discovery, this makes the
 * current service explicitly depend on the existing Drizzle/session setup.
 */
...
/**
 * Production group service. A future Activity/Lifecycle integration can pass
